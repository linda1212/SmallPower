$(function () {
    var e = echarts.init(document.getElementById("echarts-line-chart")), a = {
        title: {text: "太谷近7个月售电业绩分析"},
        tooltip: {trigger: "axis"},
        legend: {data: ["单位：万元"]},
        grid: {x: 50, x2: 40, y2: 24},
        calculable: !0,
        xAxis: [{type: "category", boundaryGap: !1, data: ["3月份", "4月份", "5月份", "6月份", "7月份", "8月份", "9月份"]}],
        yAxis: [{type: "value", axisLabel: {formatter: "{value}"}}],
        series: [{
            name: "最高业绩",
            type: "line",
            data: [800, 1200, 1500, 1600, 1900, 2100, 2600],
    ...
    var t = echarts.init(document.getElementById("echarts-bar-chart")), n = {
        ...
        series: [{
            name: "蒸发量",
            type: "bar",
            data: [280, 300, 300, 500, 600, 800, 1200, 1500, 1600, 1900, 2100, 2600],
            markPoint: {data: [{type: "max", name: "最大值"}, {type: "min", name: "最小值"}]},
            markLine: {data: [{type: "average", name: "平均值"}]}
        }, {
            name: "其他",
            type: "bar",
            data: [180, 200, 180, 400, 480, 760, 1080, 1100, 800, 600, 1600, 1000],
            markPoint: {
    ...
    var i = echarts.init(document.getElementById("echarts-k-chart")), m = {
        ...
        tooltip: {
            trigger: "axis", formatter: function (e) {
                ...
                return a += "<br/>  电价 : " + e[0].value[0] + "  峰电价 : " + e[0].value[3], a += "<br/>  平电价 : " + e[0].value[1] + "  谷电价 : " + e[0].value[2]
            }
        },
        legend: {data: ["电价"]},
        grid: {x: 40, x2: 2},
        ...
        xAxis: [{
            ...
            axisTick: {onGap: !1},
            splitLine: {show: !1},
            data: ["2017/1/24", "2017/1/25", "2017/1/28", "2017/1/29", "2017/1/30", "2017/1/31", "2017/2/1", "2017/2/4", "2017/2/5", "2017/2/6", "2017/2/7", "2017/2/8", "2017/2/18", "2017/2/19", "2017/2/20", "2017/2/21", "2017/2/22", "2017/2/25", "2017/2/26", "2017/2/27", "2017/2/28", "2017/3/1", "2017/3/4", "2017/3/5", "2017/3/6", "2017/3/7", "2017/3/8", "2017/3/11", "2017/3/12", "2017/3/13", "2017/3/14", "2017/3/15", "2017/3/18", "2017/3/19", "2017/3/20", "2017/3/21", "2017/3/22", "2017/3/25", "2017/3/26", "2017/3/27", "2017/3/28", "2017/3/29", "2017/4/1", "2017/4/2", "2017/4/3", "2017/4/8", "2017/4/9", "2017/4/10", "2017/4/11", "2017/4/12", "2017/4/15", "2017/4/16", "2017/4/17", "2017/4/18", "2017/4/19", "2017/4/22", "2017/4/23", "2017/4/24", "2017/4/25", "2017/4/26", "2017/5/2", "2017/5/3", "2017/5/6", "2017/5/7", "2017/5/8", "2017/5/9", "2017/5/10", "2017/5/13", "2017/5/14", "2017/5/15", "2017/5/16", "2017/5/17", "2017/5/20", "2017/5/21", "2017/5/22", "2017/5/23", "2017/5/24", "2017/5/27", "2017/5/28", "2017/5/29", "2017/5/30", "2017/5/31", "2017/6/3", "2017/6/4", "2017/6/5", "2017/6/6", "2017/6/7", "2017/6/13"]
        }],
        yAxis: [{type: "value", scale: !0, boundaryGap: [.01, .01]}],
        series: [{
            name: "价格",
            type: "k",
            data: [[1.26, 1.6, 1.3, 1.94], [1, 1.3, 1.26, 1.38], [1.35, 1.5, 1.35, 1.92], [1.22, 1.98, 1.35, 1.8], [1.75, 1.48, 1.89, 1.76], [1.43, 1.42, 1.23, 1.82], [1.41, 1.02, 1.57, 1.15], [1.92, 1.15, 1.58, 1.38], [1, 1.13, 1.3, 1.42], [1.68, 1.48, 1.7, 1.73], [1.69, 1.53, 1.22, 1.89], [1.62, 1.4, 1.4, 1.03], [1.91, 1.56, 1.43, 1.8], [1.26, 2382.91, 2373.53, 2427.07], [2383.49, 2397.18, 2370.61, 2397.94], [2378.82, 2325.95, 2309.17, 2378.82], [2322.94, 2314.16, 2308.76, 2330.88], [1.62, 2325.82, 2315.01, 2338.78], [2313.74, 2293.34, 2289.89, 2340.71], [2297.77, 2313.22, 2292.03, 2324.63], [2322.32, 2365.59, 2308.92, 2366.16], [2364.54, 2359.51, 2330.86, 2369.65], [2332.08, 2273.4, 2259.25, 2333.54], [2274.81, 2326.31, 2270.1, 2328.14], [2333.61, 2347.18, 2321.6, 2351.44], [2340.44, 2324.29, 2304.27, 2352.02], [2326.42, 2318.61, 2314.59, 2333.67], [2314.68, 2310.59, 2296.58, 1.96], [2309.16, 2286.6, 2264.83, 2333.29], [2282.17, 2263.97, 2253.25, 2286.33], [2255.77, 2270.28, 2253.31, 2276.22], [2269.31, 2278.4, 2250, 2312.08], [2267.29, 2240.02, 2239.21, 2276.05], [2244.26, 2257.43, 2232.02, 2261.31], [2257.74, 2317.37, 2257.42, 2317.86], [2318.21, 2324.24, 2311.6, 2330.81], [2321.4, 2328.28, 2314.97, 2332], [2334.74, 2326.72, 2319.91, 2344.89], [2318.58, 2297.67, 1.12, 2319.99], [2299.38, 2301.26, 2289, 2323.48], [2273.55, 2236.3, 2232.91, 2273.55], [2238.49, 2236.62, 2228.81, 2246.87], [2229.46, 2234.4, 2227.31, 2243.95], [2234.9, 2227.74, 2220.44, 2253.42], [2232.69, 2225.29, 2217.25, 2241.34], [2196.24, 2211.59, 2180.67, 2212.59], [2215.47, 2225.77, 2215.47, 2234.73], [2224.93, 2226.13, 2212.56, 2233.04], [2236.98, 2219.55, 2217.26, 2242.48], [2218.09, 2206.78, 2204.44, 2226.26], [2199.91, 2181.94, 2177.39, 2204.99], [2169.63, 2194.85, 2165.78, 2196.43], [2195.03, 2193.8, 2178.47, 2197.51], [2181.82, 2197.6, 2175.44, 2206.03], [2201.12, 2244.64, 2200.58, 2250.11], [2236.4, 2242.17, 2232.26, 2245.12], [2242.62, 2184.54, 2182.81, 2242.62], [2187.35, 2218.32, 2184.11, 2226.12], [2213.19, 2199.31, 2191.85, 2224.63], [2203.89, 2177.91, 2173.86, 2210.58], [2170.78, 1.12, 1.14, 1.65], [1.05, 1.5, 1.05, 1.81], [1.5, 1.17, 1.5, 1.07], [1.86, 1.57, 1.44, 1.26], [1.39, 1.3, 1.42, 1.21], [1.96, 1.97, 1.38, 1.86], [1.82, 1.83, 1.81, 1.67], [1.68, 1.92, 1.36, 2250.85], [2238.9, 2217.01, 1.87, 1.93], [1.09, 1.8, 1.58, 1.19], [1.34, 1.81, 1.77, 1.87], [1.81, 1.87, 1.41, 1.09], [1.33, 2299.99, 1.9, 2309.39], [1.11, 1.11, 1.12, 1.3], [1.75, 1.4, 1.43, 1.18], [1.81, 1.1, 1.1, 1.95], [1.45, 1.53, 1.25, 1.59], [2286.66, 2293.08, 2283.94, 2301.7], [1.4, 1.32, 1.47, 1.1], [1.54, 1.02, 1.17, 1.33], [1.25, 1.75, 1.49, 1.72], [1.74, 1.59, 1.37, 1.53], [1.21, 1.25, 1.11, 1.43], [1.1, 1.42, 1.76, 1.1], [1.71, 1.93, 1.87, 1.86], [1.43, 1.11, 1.07, 1.69], [1.26, 1.9, 1.07, 1.63], [1.1, 1.35, 1.22, 1.1]]
        }]
    };
    ...
    var l = echarts.init(document.getElementById("echarts-pie-chart")), u = {
        ...
        legend: {orient: "vertical", x: "left", data: ["直接访问", "邮件营销", "线上营销", "客户介绍", "其他"]},
        calculable: !0,
        series: [{
            name: "访问来源",
            type: "pie",
            radius: "55%",
            center: ["50%", "60%"],
            data: [{value: 335, name: "其他"}, {value: 310, name: "邮件营销"}, {value: 234, name: "线上营销"}, {
                value: 135,
                name: "客户介绍"
    ...
    var s = echarts.init(document.getElementById("echarts-map-chart")), c = {
        ...
        legend: {orient: "vertical", x: "left", data: ["期货售电", "现货售电"]},
